...
### Tools and Tutorials
- [Voyant Tools Guide](https://voyant-tools.org/)
- [AntConc Tutorial](https://www.laurenceanthony.net/software/antconc/)
...
- [JSTOR Daily](https://daily.jstor.org/) — Recent articles
- [Reddit Data](https://pushshift.io/) — Historical Reddit data
- [Kaggle Datasets](https://www.kaggle.com/) — Diverse datasets
- [Text Analysis News Archive](https://www.lexisnexis.com/) — News texts
