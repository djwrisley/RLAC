...
> This course site is created in GitHub Pages using the Minimal Mistakes theme. We will be using the same for lab today, although when you gain more confidence you will be able to change to other themes and customize to your own liking.
