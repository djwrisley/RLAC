...
- **Methodological Expectations:** <br>- How can you compare the different methods Stylo for hierarchical cluster and TF-IDF PCA clustering for what they purport to analyze? <br>- What do you think about the idea of function word analysis or most distinctive word analysis as a way of doing distant reading? 

- **Computational Insights:** <br>- What did the computational analysis of the corpus teach you about science fiction / speculative fiction that you did not already know? <br>- How does the wordlist generated by Stylo compare to the loadings that you can visualize in the TF-IDF PCA visualization? <br>- What words occur in both of them? What words are specific to one approach? <br>- Was the gender of the writers linked to any stable kind of clustering? 
