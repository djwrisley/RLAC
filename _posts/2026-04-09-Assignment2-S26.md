...
When you download the folders, click on either `light.html` or `dark.html` to view the visualization in the browser. You can use the interactive buttons to look at different information from the data. 
