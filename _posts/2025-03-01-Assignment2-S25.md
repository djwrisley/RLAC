...
**Step 1**: Choice of topic that you would like to work on from within the Zanzibar Gazette pdfs (. You should identify the sourcebook you would like to work with. Below is a list of possible sources from archive.org, but you can also find your own. **Please check with the instructor if you use one which is not included below**. 
