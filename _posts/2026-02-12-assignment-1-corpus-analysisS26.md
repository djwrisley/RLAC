...
1. **Corpus Selection:** Choose three or more texts that you'd like to work with. 
2. **Exploratory Analysis:** Use a combination of Voyant Tools and the R Notebooks to conduct exploratory data analysis on your corpus
...
Choose three or more texts from either corpus that you'd like to work with. 
...
- **Voyant Tools** (https://voyant-tools.org/): A web-based suite for exploratory text analysis. Provides visualizations like word clouds, trend graphs, and concordances. Works well for smaller corpora (a handful of texts to a few dozen).
...
https://voyant-tools.org/tool/Cirrus/?corpus=8d8c7ce89087801d676ff4f77d5391fc

## Step 6: Integrate Course Materials

Read the chapter "The Risks of Distant Reading" (pp 143-169) from Ted Underwood's [_Distant Horizons_](https://search.abudhabi.library.nyu.edu/permalink/01NYU_AD/indfm6/alma990074332960107871), available as an e-book and refer to it in your assignment. 
...
As you write, consider (but don't feel obligated to answer) these questions:
...
- **Computational Insights:** What does computational analysis reveal that a linear read would not? Would reading all texts cover-to-cover have been feasible in your timeline? What new patterns emerged?

- **Comparative Insights:** What did Voyant Tools allow you to do that the R Notebooks did not? How was working with the two methods different? similar? 
...
- **Methodological Questions:** If you reran your analysis, did you get consistent results? Why or why not? How do different visualization methods represent the data differently? Were there limitations in the tools or approaches you used? What risks are there in reading this way (draw on Underwood)
...
**Writing:** Use tools like [Markdown Live Preview](https://markdownlivepreview.com/) and [Hemingway App](https://hemingwayapp.com/) to refine your prose for clarity and legibility. Keep the F-shape principle for web writing in mind—readers scan top-to-bottom and left-to-right, so structure your argument visibly.

**Visualization:** Make your screenshots speak. Use clear captions that explain what readers are seeing and why it matters to your argument. Your visualizations should support and enhance your analysis, not merely decorate it.
