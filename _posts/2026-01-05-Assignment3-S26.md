...
- Which words are closest to a given target word (nearest neighbors)? Do these neighbors match your expectations? 
...
- Is `word2vec` analysis an interesting method to you? Compare it to others we have looked at. 
