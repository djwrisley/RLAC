...
- including, but not limited to, distant reading, close reading, surface reading, computational thinking, static sites, distant coding, Markdown, GitHub, Voyant Tools, wordclouds, data visualization, text editor, corpus, tidyverse, stopwords, R package
